          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="flex flex-col relative z-10">
              <div className="prose prose-invert max-w-none mb-12">
                <p className="text-foreground/80 text-lg md:text-xl leading-relaxed font-mono border-l-2 border-primary/30 pl-6 bg-gradient-to-r from-primary/5 to-transparent py-4 rounded-r-2xl">
                  ...
                  return (
                    <a
                      ...
                      className={`flex items-center justify-center gap-3 px-8 py-4 font-black rounded-2xl transition-transform text-center uppercase text-sm tracking-widest ${
                        isDownload
                          ? "sm:col-span-2 bg-secondary text-black hover:scale-[1.02]"
                          : isPrimary
